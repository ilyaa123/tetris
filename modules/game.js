...
export class Game {
    ...
    createTetromino(){
        ...
        const lettterTentomino = keys[Math.floor(Math.random() * keys.length)];
        const rotation = tetrominoes[lettterTentomino];
    ...
    showResult(endTetris){
        endTetris(this.lines, this.score, this.level)
    }
}